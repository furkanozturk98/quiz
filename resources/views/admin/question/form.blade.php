<x-app-layout>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ $question->exists ? route('questions.update',$quiz) : route('questions.store',$quiz)}}" enctype="multipart/form-data" method="POST">
                @csrf
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea name="answer1"
                                      class="form-control {{ $errors->has('answer1') ? 'is-invalid' : '' }}" rows="2">{{ old('description' ,$quiz->answer1) }}</textarea>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea name="answer2"
                                      class="form-control {{ $errors->has('answer2') ? 'is-invalid' : '' }}" rows="2">{{old('description' ,$quiz->answer2) }}</textarea>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea name="answer3"
                                      class="form-control {{ $errors->has('answer3') ? 'is-invalid' : '' }}" rows="2">{{ old('description' ,$quiz->answer3) }}</textarea>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea name="answer4"
                                      class="form-control {{ $errors->has('answer4') ? 'is-invalid' : '' }}" rows="2">{{ old('description' ,$quiz->answe4) }}</textarea>
